  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4'>
        ...
        <button
          className='bg-slate-700 text-white first-letter:rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80'
          type='button' // Assuming this is not a form submit button
        >
          update
        </button>
      </form>
